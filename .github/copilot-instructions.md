# Copilot Compatibility Instructions - `minio-microservice`
...
Repository: [https://github.com/speakASAP/minio](https://github.com/speakASAP/minio)
Authoritative checkout: `/home/ssf/Documents/Github/minio-microservice` on `alfares`.
