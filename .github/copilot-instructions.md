# Copilot Instructions — `minio-microservice`
...
- **Authoritative path**: `/home/ssf/Documents/Github/minio-microservice` on the `alfares` server.
- **Origin**: `git@github.com:speakASAP/minio.git`, branch `main`.
