# SUB-003: Operational Diagnostics
...
downstream:
  - ../10_features/FEAT-003-operator-diagnostics.md
related_adrs:
  - ADR-001
```

## Purpose
Give operators repeatable commands for diagnosing MinIO, bucket, proxy, TLS, CORS, and signature issues.
