...
echo "     WARNING: only if ${SPEAKASAP_RECORDS_MOUNT} is EMPTY. Binding over a"
echo "     populated directory hides its contents (the data is not deleted, but"
echo "     becomes invisible to MinIO and every consumer until unmounted)."
